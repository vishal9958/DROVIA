...
export default function MobileConnecting({ onNavigate, pin }: ConnectingProps) {
  ...
  return (
    ...
    >
      <div style={{ width: "100%", padding: "48px 24px", textAlign: "center" }} className="animate-fade-up">
        ...
        {/* Progress stages */}
        {!done && (
          <div className="text-left glass rounded-2xl p-5 flex flex-col gap-4">
            {stages.map((s, i) => {
